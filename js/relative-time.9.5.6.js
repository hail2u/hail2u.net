...
var e = {day:24, hour:60, minute:60, month:30, second:1000, year:12}, g = performance.timing.navigationStart + performance.now(), k = {day:"\u65e5", hour:"\u6642\u9593", minute:"\u5206", month:"\u304b\u6708", now:"\u305f\u3063\u305f\u4eca", second:" \u79d2", year:"\u5e74"};
function l(a) {
  if (Number.isInteger(a) && (a = Math.round((g - a) / e.second), Number.isInteger(a) && !(0 > a))) {
    if (a < e.minute / 2) {
      return k.now;
    }
    if (a < e.minute) {
