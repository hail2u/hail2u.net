...
for(var r=p(document.querySelectorAll("*")),t=r.next();!t.done;t=r.next()){var u=t.value;"ellipsis"===window.getComputedStyle(u)["text-overflow"]&&(u.title=u.textContent)};/*
 ...
 LICENSE: http://hail2u.mit-license.org/2016
*/
var v=performance.timing.navigationStart+performance.now();function w(){var a=Date.parse(x);if(Number.isInteger(a)&&(a=parseInt((v-a)/1E3,10),Number.isInteger(a)&&!(0>a))){if(30>a)return"\u305f\u3063\u305f\u4eca";if(90>a)return a+"\u79d2\u524d";a=parseInt(a/60,10);if(90>a)return a+"\u5206\u524d";a=parseInt(a/60,10);if(36>a)return a+"\u6642\u9593\u524d";a=parseInt(a/24,10);if(45>a)return a+"\u65e5\u524d";a=parseInt(a/30,10);return 18>a?a+"\u30f6\u6708\u524d":parseInt(a/12,10)+"\u5e74\u524d"}}
