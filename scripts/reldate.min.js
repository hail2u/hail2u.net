...
(function(){for(var a=Date.now(),c=function(b){if(Number.isInteger(b)&&(b=parseInt((a-b)/1E3,10),Number.isInteger(b)&&!(0>b))){if(60>b)return b+"\u79d2\u524d";b=parseInt(b/60,10);if(60>b)return b+"\u5206\u524d";b=parseInt(b/60,10);if(24>b)return b+"\u6642\u9593\u524d";b=parseInt(b/24,10);if(30>b)return b+"\u65e5\u524d";b=parseInt(b/30,10);return 12>b?b+"\u30f6\u6708\u524d":parseInt(b/12,10)+"\u5e74\u524d"}},e=$jscomp.makeIterator(document.querySelectorAll("time")),d=e.next();!d.done;d=e.next()){var d=
d.value,f=d.getAttribute("datetime"),g="";f&&(g=c(Date.parse(f)))&&(d.setAttribute("title",f),d.textContent=g)}})();