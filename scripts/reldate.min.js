...
(function(){function a(a){if(Number.isInteger(a)&&(a=parseInt((c-a)/1E3,10),Number.isInteger(a)&&!(0>a))){if(0===a)return"\u305f\u3063\u305f\u4eca";if(60>a)return a+"\u79d2\u524d";a=parseInt(a/60,10);if(60>a)return a+"\u5206\u524d";a=parseInt(a/60,10);if(24>a)return a+"\u6642\u9593\u524d";a=parseInt(a/24,10);if(30>a)return a+"\u65e5\u524d";a=parseInt(a/30,10);return 12>a?a+"\u30f6\u6708\u524d":parseInt(a/12,10)+"\u5e74\u524d"}}var c=Date.now(),b,d=$jscomp.makeIterator(document.querySelectorAll("time"));
for(b=d.next();!b.done;b=d.next()){b=b.value;var e=b.getAttribute("datetime"),f=a(Date.parse(e));f&&(b.setAttribute("title",e),b.textContent=f)}})();