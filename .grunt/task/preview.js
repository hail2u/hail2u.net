...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="./fonts/megrim.min.css">
    <link rel="stylesheet" href="./fonts/source-code-pro.min.css">
    <link rel="stylesheet" href="./fonts/source-sans-pro.min.css">
  </head>

  <body class="permalink">
    <header role="banner">
      <h1><a id="logo" href="./"><img src="./images/logo.min.svg" alt="Hail2u.net"></a></h1>
    ...
    <footer role="contentinfo">
      <section class="footlinks">
        <ul>
          ...
          <li><a rel="alternate" type="application/rss+xml" href="./feed">RSS</a></li>
        </ul>
      </section>
